...
# docker build --rm -t oswee/public-web:latest . -f build/Dockerfile
# docker run --rm -it -d -p 8080:8080/tcp --name public-web oswee/public-web:latest   // Remove "-d" to see logs